...
class Contractor{
    ...
    sayHello(){
        console.log(`Hello, my name is ${this._name}, I'm on the ${this._role} team!`)
    }
    sayBye(){
...
let machi = new FrontEnd('The Machine', 'Front-End', 'React')
let simba = new BackEnd('Simba', 'Back-End', 'Node')
